    ...
    >
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        ...
        <form onSubmit={handleSubmit}>
          {/* Row 1: Nama Perusahaan + Alamat Perusahaan */}
          ...
          {/* Row 2: Nama Peminta RFQ (full width) */}
          <div className="mb-4">
          ...
          {/* Row 5: Checkbox — simpan informasi */}
          ...
          {/* Row 6: WhatsApp + Kirim RFQ buttons */}
